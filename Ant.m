function [ResultRoute, ResulrTime, ResultLength, ResultDifficult] = Ant(citys)
...
while Gen <= MaxGen
    ...
    RouteTable(:, citys_num) = 2* ones(AntNum, 1);   %终点为点75
    ...
    if Gen == 1
        ...
        BestRoute(Gen, :) = change(BestRoute(Gen, :), citys);
